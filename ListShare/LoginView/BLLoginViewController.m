...
- (void)viewDidLoad
{
    ...
    [self.logInView setBackgroundColor:[UIColor turquoiseColor]];
    ...
    */
    ...
    self.logInView.passwordForgottenButton.titleLabel.textColor = [UIColor turquoiseColor];
    self.logInView.passwordForgottenButton.titleLabel.text = @"Forgot?";
    [self.logInView.passwordForgottenButton.imageView setHidden:YES];
